...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajouter un ordinateur</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-xs-12">
                                    <form action="" method="post" class="">
                                         <div class="form-group"> 
                                            ...
                                            <input type="text" class="input-lg form-control" id="name" name="name" placeholder="Nom" value="">
                                         </div> 
                                         <div class="form-group"> 
                                             <label for="name">Date d'introduction</label> 
                                            <input type="text" class="input-lg form-control" id="introduced" name="introduced" placeholder="Date d'introduction (dd/mm/yyyy)" value="">
                                         </div> 
                                         <div class="form-group"> 
                                             <label for="name">Date de discontinuité</label> 
                                            <input type="text" class="input-lg form-control" id="discontinued" name="discontinued" placeholder="Date de discontinuité (dd/mm/yyyy)" value="">
                                         </div> 
                                         <div class="form-group">
