...
public interface ComputerDAO {
    ...
    /** function wich call a function in ComputerDAO to execute a sql requete to create a computer in the database.
     * @throws DAOException a DAO exception (src/main/daoUtil)
    ...
    /** function wich call a function in ComputerDAO to execute a sql requete to update a computer in the database.
     * @throws DAOException a DAO exception (src/main/daoUtil)
     * @param computer the computer to update in the database
     * */
    void updateComputer(Computer computer) throws DAOException;

    /** function wich call a function in ComputerDAO to execute a sql requete to delete a computer in the database.
     * @throws DAOException a DAO exception (src/main/daoUtil)
