...
public interface ComputerDAO {
     ...
     *             if the argument have a problem
     * @param computer
     *            the computer to create in the database
     */
     ...
     *             a DAO exception (src/main/daoUtil)
     * @param computer
     *            the computer to update in the database
     */
     ...
     *             a DAO exception (src/main/daoUtil)
     * @param id
     *            the id of the computer to delete in the database
     */
