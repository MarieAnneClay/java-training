...
public class ServiceComputerTest extends TestCase {
    ...
    public void testCreateComputer() {
        ...
        // Mockito.when(computer.getIntroduced()).thenReturn(Timestamp.valueOf("1991-01-01
        // 00:00:00"));
        // Mockito.when(computer.getDiscontinued()).thenReturn(Timestamp.valueOf("1991-01-01
        // 00:00:00"));
